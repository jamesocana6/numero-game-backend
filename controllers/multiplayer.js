...
//         });
//       } else {
//         activeRooms.get(room)[socket.id] = new Player(
//           [],
//           [],
//           [],
//           false,
...
//         );
//       }
//       const players = Object.values(activeRooms.get(room)).map((player) => ({
//         ready: player.ready,
...
//     const players = Object.values(roomData).map((player) => ({
//       ready: player.ready,
//       username: player.username,
//     }));
