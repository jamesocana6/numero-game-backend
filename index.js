...
const InitializeSockets = require("./controllers/sockets/socketHub.js");
...
app.use(
  cors({
    credentials: true,
    origin: ["https://computiles.com", "http://localhost:3000"],
  }),
...
db.on("error", (err) =>
  console.log(err.message + "we got an error connecting the DB"),
);
